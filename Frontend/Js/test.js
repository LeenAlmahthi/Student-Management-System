...
// let response = await
// fetch("http://localhost:5000/api/authApplication/Login", {
//     method: "POST",
...
//   // this will apply the defualt of the form  ||
//   login.html?name=omar+88&password=jhj:90 q.classList.toggle("active");
//   console.log(q.value);
// });

// q.addEventListener("change" , () => { // when u clcik in anther things in the
// screen u will apply this
//     console.log("[");
//     console.log(q.value);
//     console.log("]");
// })
//    q.addEventListener("input" , () => { // every char u write it in the input
//    will direct print in console
//     console.log("[");   // [ l
//     console.log(q.value);
//     console.log("]");
// })
